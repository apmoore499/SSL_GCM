...
for si in (seq 0 99)
	python src/benchmarks_CGAN_disjoint.py --d_n=n36_gaussian_mixture_d7_100000 --s_i=$si --n_iterations=100 --lr=1e-3 --use_single_si=True --tot_bsize=256 --lab_bsize=4 --use_bernoulli=False --use_benchmark_generators=False --estop_patience=10 ;
end
