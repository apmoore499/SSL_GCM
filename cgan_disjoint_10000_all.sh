...
# for si in {0..99}
# do
# python src/benchmarks_CGAN_disjoint.py --d_n=n36_gaussian_mixture_d2_10000 --lr=1e-3 --s_i=$si --n_iterations=100 --lr=1e-3 --use_single_si=True --tot_bsize=256 --lab_bsize=4 --use_bernoulli=False --use_benchmark_generators=False --estop_patience=10 ;
# done
