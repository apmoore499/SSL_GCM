...
for si in {1..5}
do
python src/benchmarks_CGAN_disjoint.py --d_n=$d_n --lr=1e-3 --s_i=$si --n_iterations=100 --lr=1e-3 --use_single_si=True --tot_bsize=256 --lab_bsize=4 --use_bernoulli=False --use_benchmark_generators=False --estop_patience=10 --plot_synthetic_dist=True --estop_mmd_type=$estop_mmd_type
done
...
for si in {1..5}
do
python src/benchmarks_CGAN_disjoint.py --d_n=$d_n --lr=1e-3 --s_i=$si --n_iterations=100 --lr=1e-3 --use_single_si=True --tot_bsize=256 --lab_bsize=4 --use_bernoulli=False --use_benchmark_generators=False --estop_patience=10 --plot_synthetic_dist=True;
done
