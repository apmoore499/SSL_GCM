...
def run_sslgan_model(d_n,#=d_n,
    ...
    for t in range(n_trials):
        ...
        clear_saved_models(current_model_name, dspec.save_folder, s_i)
...
def objective(trial,sel_si):
    ...
    params={
        ...
        "d_n":trial.suggest_categorical('d_n',['n36_gaussian_mixture_d6_5000'])#,'n36_gaussian_mixture_d3_5000','n36_gaussian_mixture_d4_5000','n36_gaussian_mixture_d5_5000','n36_gaussian_mixture_d6_5000','n36_gaussian_mixture_d7_5000','n36_gaussian_mixture_d2_10000','n36_gaussian_mixture_d3_10000','n36_gaussian_mixture_d4_10000','n36_gaussian_mixture_d5_10000','n36_gaussian_mixture_d6_10000','n36_gaussian_mixture_d7_10000'])
    ...
    for s_i in sel_si[0]:
        ...
        res=run_sslgan_model(d_n=params['d_n'],
                                lr=lr,
                                s_i=s_i,
                                n_iterations=n_iterations,
                                tot_bsize=tot_bsize,
...
#for d_n in ['n36_gaussian_mixture_d2','n36_gaussian_mixture_d3','n36_gaussian_mixture_d4','n36_gausssian_mixture_d5','n36_gaussian_mixture_d6','n36_gaussian_mixture_d7']:
for d_n in ['n36_gaussian_mixture_d2_5000','n36_gaussian_mixture_d3_5000','n36_gaussian_mixture_d4_5000','n36_gaussian_mixture_d5_5000','n36_gaussian_mixture_d6_5000','n36_gaussian_mixture_d7_5000','n36_gaussian_mixture_d2_10000','n36_gaussian_mixture_d3_10000','n36_gaussian_mixture_d4_10000','n36_gaussian_mixture_d5_10000','n36_gaussian_mixture_d6_10000','n36_gaussian_mixture_d7_10000']:
